...
public class MilenioMain extends Activity {
 ...
 public	static ImageView imgclima;
 	...
 	static ArrayList<String> seccionesl;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        seccionesl = new ArrayList<String>();
    	...
    	final Spinner secciones = (Spinner)findViewById(R.id.secciones);
     	...
     	final ExpandableListView secciones2 = (ExpandableListView)findViewById(R.id.exseccion);
     	mAdapter = new MiExpandableListAdapter();
     	
     	secciones2.setAdapter(mAdapter);
        ...
        //secciones
        ArrayAdapter<String> asecciones = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,seccionesl);
	...
	String obtenersec = func.getValores("http://www.milenio.com/xmlmovil/secciones_ediciones.js");
	 try {
		...
		for (int i = 0; i < jsonsec.length(); i++) {
		      ...
		      //Obtenemos la parte de la id que representa la edcion
